...
namespace Projekat.Model
{
    public class AnamnezaIzvestaj
    {
        ...
        public DataTable MakeDataTable(Termin izabranTermin)
        {
            ...
            //Define columns
            tabela.Columns.Add("Datum izdavanja anamneze");
            tabela.Columns.Add("Opis bolesti");
            tabela.Columns.Add("Terapija");
            tabela.Columns.Add("Lekar koji je izdao anamnezu");
            /*string dani = "Terapija";
            string jacina = "Lekar koji je izdao anamnezu";
            ...
            foreach (Anamneza r in p.Karton.Anamneze)
            {
                tabela.Rows.Add(new string[] { r.Datum,
                        r.OpisBolesti, r.Terapija, r.ImePrezimeLekara });
            }
